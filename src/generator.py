...
def build_prompt(
    ...
    part0 = (
        ...
        "\n"
        "LAW 12 — ENDING: See PART 4b for the ending menu. Pick ONE\n"
    ...
    part5 = (
        ...
        "  Mix 1-line reactions, 2-3 line replies, 4-5 line emotional\n"
        "  replies. No forced pattern. No same-length 3+ times in a row.\n"
        "\n"
        "─── Emotional arc ───\n"
